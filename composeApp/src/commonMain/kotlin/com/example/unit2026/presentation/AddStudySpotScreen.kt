...
fun AddStudySpotScreen(
    ...
    Column(
        ...
        Text(
            text = "Uživatel zadá název místa a případný komentář. Admin potom může validní místo dohledat, doplnit souřadnice a uložit ho do databáze.",
        ...
        Card(
            ...
            Column(
                ...
                OutlinedTextField(
                    ...
                    placeholder = {
                        Text("e.g. Campus Library Atrium")
                    },
                    singleLine = true,
